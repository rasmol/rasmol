...
static langstr langstrs[] = {
  ...
  { "RasMol ¤Оё¶№Ж(&c)  ...",                           StrMSCR,     Japanese,8},  
  ...
  { "µ­Пї",                                        StrRegister, Japanese,0},
  { "ґуЙХ¤·¤К¤µ¤¤",                                          StrDonate,   Japanese,0},
  { "і«»П¤З¤і¤ОҐАҐ¤ҐўҐнҐ°¤тјЁ¤·¤Ж¤П¤¤¤±¤К¤¤",              StrNoShow,   Japanese,0},
  { "КЭѕЪМµ¤·ЎўҐЄЎјҐЧҐуҐЅЎјҐ№ЎўGPL ¤ОЗ§¤б¤й¤м¤лґуЙХ", StrWarranty, Japanese,0}
