...
static langstr langstrs[] = {
  ...
  { "RasMol ‚МЊґЌe(&c)  ...",                           StrMSCR,     Japanese,8},  
  ...
  { "Љс•t‚µ‚И‚і‚ў",                                          StrDonate,   Japanese,0},
  { "ЉJЋn‚Е‚±‚Мѓ_ѓCѓAѓЌѓO‚рЋ¦‚µ‚Д‚Н‚ў‚Ї‚И‚ў",              StrNoShow,   Japanese,0},
  { "•ЫЏШ–і‚µЃAѓIЃ[ѓvѓ“ѓ\Ѓ[ѓXЃAGPL ‚М”F‚Я‚з‚к‚йЉс•t", StrWarranty, Japanese,0}
