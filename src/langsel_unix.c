...
static langstr langstrs[] = {
  ...
  { "ҐіҐЮҐуҐЙ¤ОКёЛЎ¤¬ЙФЕ¬АЪ¤З¤№!\n",                   ErrSyntax,   Japanese,0},
  { "ҐСҐйҐбЎјҐїЎј¤¬Вз¤­¤№¤®¤Ю¤№!\n",                        ErrBigNum,   Japanese,0},
  { "ҐСҐйҐбЎјҐїЎј¤ОАЯДк¤¬ЙФЕ¬АЪ¤З¤№!\n",                    ErrBadOpt,   Japanese,0},
  { "ҐСҐйҐбЎјҐїЎјМѕ¤¬ЙФЕ¬АЪ¤З¤№!\n",                        ErrParam,    Japanese,0},
  { "ҐХҐЎҐ¤ҐлМѕ¤тјЁ¤№Кё»ъОу¤¬¤ў¤к¤Ю¤»¤у!\n",                 ErrFilNam,  Japanese,0},
  { "К¬»Т№ЅВ¤ҐЗЎјҐїЎјҐЩЎјҐ№¤тЖЙ¤Я¤Ю¤·¤ї!\n",                 ErrBadLoad,  Japanese,0},
  { "А°їфГН¤т»ШДк¤№¤лЙ¬НЧ¤¬¤ў¤к¤Ю¤№!\n",                     ErrNotNum,   Japanese,0},
  { "¶иАЪ¤кЎКҐіҐуҐЮЎЛ¤¬¤ў¤к¤Ю¤»¤у! \n",                     ErrNotSep,   Japanese,0},
  { "±¦Ґ«ҐГҐі ']' ¤¬¤ў¤к¤Ю¤»¤ў¤к¤Ю¤»¤у!\n",                 ErrNotBrac,  Japanese,0},
  { "ї§¤¬»ШДк¤µ¤м¤Ж¤¤¤Ю¤»¤у!\n",                           ErrNoCol,    Japanese,0},
  { "ї§¤О»ШДк¤¬ЙФЕ¬АЪ¤З¤№!\n",                             ErrColour,   Japanese,0},
  { "ҐіҐЮҐуҐЙ¤О°ъїф¤¬ЙФЕ¬АЪ¤З¤№!\n",                   ErrBadArg,   Japanese,0},
  { "ЙЅёЅ¤Лён¤к¤¬¤ў¤к¤Ю¤№!\n",                         ErrBadExpr,  Japanese,0},
  { "±¦Ґ«ҐГҐі ')' ¤¬¤ў¤к¤Ю¤»¤у!\n",                       ErrParen,    Japanese,0},
  { "Ґ№ҐЇҐкҐЧҐИ¤¬КЈ»Ё¤№¤®¤Ю¤№!\n",                         ErrScript,   Japanese,0},
  { "єёҐ«ҐГҐі '(' ¤¬¤ў¤к¤Ю¤»¤у!\n",                        ErrFunc,     Japanese,0}, 
  { "ё¶»ТГД¤ОМѕБ°¤¬ЙФЕ¬АЪ¤З¤№!\n",                         ErrSetName,  Japanese,0},
  { "ё¶»ТГД¤тДкµБ¤№¤л¤ї¤б¤ЛЙ¬НЧ¤КҐбҐвҐкЎј¤¬іОКЭ¤З¤­¤Ю¤»¤у!\n",  ErrBadSet,   Japanese,0},
  { "Ґ№ҐЇҐкҐЧҐИҐХҐЎҐ¤Ґл¤З¤П»И¤Ё¤К¤¤ҐіҐЮҐуҐЙ¤¬¤ў¤к¤Ю¤№!\n",     ErrInScrpt,  Japanese,0},
  { "Ґ№ҐЇҐкҐЧҐИҐХҐЎҐ¤Ґл¤З¤·¤«»И¤Ё¤К¤¤ҐіҐЮҐуҐЙ¤З¤№!\n",         ErrOutScrpt, Japanese,0},
  { "К¬»Т№ЅВ¤ҐЗЎјҐїЎјҐЩЎјҐ№¤тЖЙ¤Я№ю¤б¤Ю¤»¤у!\n",              ErrBadMolDB, Japanese,0},
  { "ІуЕѕ¤О¤ї¤б¤О·л№з¤¬»ШДк¤µ¤м¤Ж¤¤¤Ю¤»¤у!\n",                ErrNoBond,   Japanese,0},
  { "ҐЁҐйЎј: ҐХҐЎҐ¤Ґл '",                                 StrErrFile,  Japanese,0},
  { "'¤¬ё«¤Д¤«¤к¤Ю¤»¤у!\n\n",                             StrNotFnd,   Japanese,0},
  { "ҐЁҐйЎј: ҐХҐЎҐ¤Ґл¤О°µЅМ·Бј°¤¬ЙФМА¤З¤№!\n\n",             StrCFmt,     Japanese,0},
  { "ҐЁҐйЎј: °µЅМ¤µ¤м¤їҐХҐЎҐ¤Ґл¤тЕёі«¤З¤­¤Ю¤»¤у!\n\n",        StrDcmp,     Japanese,0},
  { "Ґ№ҐЇҐкҐЧҐИ¤ОЈ±№Ф¤¬Д№¤№¤®¤Ю¤№!\n",                      StrSLong,    Japanese,0},
  { "ҐіҐЮҐуҐЙҐЁҐйЎј: ҐбҐвҐкЎј¤¬В­¤к¤Ю¤»¤у!\n",               StrSMem,     Japanese,0},
  { "RasMol¤ОҐШҐлҐЧҐХҐЎҐ¤Ґл¤¬ё«¤Д¤«¤к¤Ю¤»¤у!\n",             StrHFil,     Japanese,0},
  { "ҐШҐлҐЧҐХҐЎҐ¤Ґл¤Л¤К¤¤ЙФМА¤ОҐИҐФҐГҐЇҐ№¤т»ШДк¤·¤Ю¤·¤ї!\n",    StrHTop,     Japanese,0},
  { "»ШДк¤µ¤м¤їҐИҐФҐГҐЇҐ№¤Л¤ПҐЄҐуҐйҐ¤ҐуҐШҐлҐЧ¤¬¤ў¤к¤Ю¤»¤у!\n",  StrHNone,    Japanese,0},
  { "ҐіҐЮҐуҐЙҐЁҐйЎј: ҐШҐлҐЧҐХҐЎҐ¤Ґл¤ті«¤Ї¤і¤И¤¬¤З¤­¤Ю¤»¤у!\n",  StrHROpn,    Japanese,0},
  { "Кё»ъДкїф¤¬КД¤ё¤й¤м¤Ж¤¤¤Ю¤»¤у\n",                       StrCTerm,    Japanese,0},
  { "Кё»ъДкїф¤¬Д№¤№¤®¤Ю¤№!\n",                             StrCLong,    Japanese,0},
  { "їфГНЎКѕ®їфЕАЎЛ¤ОЙЅµ­¤¬ЙФЕ¬АЪ¤З¤№!\n",                   StrFNum,     Japanese,0},
  { "Гжїґ¤ЛГЦ¤Їё¶»Т¤¬¤ў¤к¤Ю¤»¤у!\n",                        StrCent,     Japanese,0},
  { "ҐЇҐкҐГҐЧҐЬЎјҐЙ¤ЛҐіҐФЎј¤З¤­¤Ю¤»¤у!\n",                   StrCClip,    Japanese,0},
  { "АЯДкЎКҐЙҐГҐИЎЛҐХҐЎҐ¤Ґл¤ті«¤Ї¤і¤И¤¬¤З¤­¤Ю¤»¤у: '",         StrDFile,    Japanese,0},
  { "Гн°Х: ҐЧҐкҐуҐїЎј¤¬»ШДк¤µ¤м¤Ж¤¤¤Ю¤»¤у!\n",               StrNPrint,   Japanese,0},
  { "Г±°МіК»Т",                                         StrUCell,    Japanese,0},
  { "¶хґЦ·І",                                           StrSGroup,   Japanese,0},
  { "·лѕЅ¤ОВРѕОА­¤¬ЙФМА¤З¤№!\n",                           StrSymm,     Japanese,0},
  { "ҐіҐЮҐуҐЙ¤¬°ХМЈЙФМА¤З¤№!\n",                           StrUnrec,    Japanese,0},
  { "Гн°Х: »Д¤к¤ОҐіҐЮҐуҐЙ¤тМµ»л¤·¤Ю¤№!\n",                  StrIgnore,   Japanese,0},
  { "Гн°Х: ҐкҐвЎјҐИҐіҐЮҐуҐЙ¤¬Д№¤№¤®¤Ю¤№!\n",                 StrRCLong,   Japanese,0},
  { "Ґ№ҐЇҐкҐЧҐИҐХҐЎҐ¤Ґл¤ті«¤Ї¤і¤И¤¬¤З¤­¤Ю¤»¤у:'",             StrSFile,    Japanese,0},
  { "ј±КМ»Т¤¬Д№¤№¤®¤Ю¤№!\n",                               StrILong,    Japanese,0},
  { "К¬»ТМѕ ............ ",                                StrMolNam,   Japanese,0},
  { "К¬Оа .............. ",                                  StrClass,    Japanese,0},
  { "ЖујЎ№ЅВ¤... ",                                     StrSecSt,    Japanese,0},
  { "ҐўҐµҐ¤Ґу¤µ¤м¤Ж¤¤¤Ю¤»¤у\n",                            StrNoAsmt,   Japanese,0},
  { "PDBҐЗЎјҐї¤ОҐмҐіЎјҐЙ¤Л¤и¤л\n",                         StrPDBRec,   Japanese,0},
  { "·Ч»»¤Л¤и¤л\n",                                      StrCalc,     Japanese,0},
  { "ҐіЎјҐЙИЦ№ж ........ ",                             StrDBCode,   Japanese,0},
  { "јВёіКэЛЎ .......... ",                                     StrExpTec,   Japanese,0},
  { "јзєї¤Оїф .......... ",                                StrNumChn,   Japanese,0},
  { "Ґ°ҐлЎјҐЧ¤Оїф ...... ",                               StrNumGrp,   Japanese,0},
  { "ё¶»Т¤Оїф .......... ",                                StrNumAtm,   Japanese,0},
  { "·л№з¤Оїф .......... ",                                StrNumBnd,   Japanese,0},
  { "S-S·л№з¤Оїф ....... ",                               StrNumBrg,   Japanese,0},
  { "їеБЗ·л№з¤Оїф ...... ",                             StrNumHbd,   Japanese,0},
  { "ҐШҐкҐГҐЇҐ№¤Оїф .... ",                             StrNumHel,   Japanese,0},
  { "Ґ№ҐИҐйҐуҐЙ¤Оїф .... ",                             StrNumStrnd, Japanese,0},
  { "ҐїЎјҐу¤Оїф ........ ",                               StrNumTrn,   Japanese,0},
  { "ҐбҐвҐкЎј¤ОіОКЭ¤ЛјєЗФ¤·¤Ю¤·¤ї",                         StrMalloc,   Japanese,0},
  { "»Дґр¤ОјпОа¤¬Вї¤№¤®¤Ю¤№",                              StrXSRes,    Japanese,0},
  { "ё¶»Т¤ОјпОа¤¬Вї¤№¤®¤Ю¤№",                              StrXSAtyp,   Japanese,0},
#ifndef MSWIN
  { "і«¤Ї...",                                         StrMOpen,    Japanese,0},
  { "КММѕ¤ЗКЭВё...",                                      StrMSaveAs,  Japanese,0},
  { "КД¤ё¤л",                                           StrMClose,   Japanese,0},
  { "",                                                StrMEmpty,   Japanese,0},
#ifdef APPLEMAC
  { "ҐЪЎјҐёАЯДк",                                      StrMPSetup,  Japanese,0},
  { "°хєю",                                           StrMPrint,   Japanese,0},
  { "ЅЄО»",                                            StrMExit,    Japanese,0},
#else
  { "ЅЄО»",                                            StrMExit,    Japanese,0},
#endif
  { "ҐпҐ¤ҐдЎјҐХҐмЎјҐа",                                    StrMWirefr,  Japanese,0},
  { "јзєї",                                              StrMBackbn,  Japanese,0},
  { "Ґ№ҐЖҐЈҐГҐЇ",                                         StrMSticks,  Japanese,1},
  { "¶хґЦЅјЕ¶ҐвҐЗҐл",                                      StrMSpacefl, Japanese,0},
  { "ЛА¶М",                                              StrMBallStk, Japanese,0},
  { "ҐкҐЬҐу",                                            StrMRibbons, Japanese,0},
  { "Ґ№ҐИҐйҐуҐЙ",                                         StrMStrands, Japanese,3},
  { "Ґ«ЎјҐИҐҐЎјҐу",                                        StrMCartoon, Japanese,0},
  { "К¬»ТЙЅММ",                                           StrMMolSurf, Japanese,0},
  { "Зт№х",                                            StrMMonochr, Japanese,0},
  { "CPKЎКҐ«ҐйЎјЎЛ",                                             StrMCPK,     Japanese,0},
  { "·Б",                                              StrMShapely, Japanese,0},
  { "Ґ°ҐлЎјҐЧ",                                         StrMGroup,   Japanese,0},
  { "єї",                                              StrMChain,   Japanese,1},
  { "І№ЕЩ",                                            StrMTemp,    Japanese,0},
  { "№ЅВ¤",                                            StrMStruct,  Japanese,2},
  { "ҐжЎјҐ¶Ўј",                                         StrMUser,    Japanese,0},
  { "ҐвҐЗҐл",                                           StrMModel,   Japanese,2},
  { "ІДґ№№ЅВ¤",                                             StrMAlt,     Japanese,0},
  { "Ґ№ҐйҐЦҐвЎјҐЙ",                                     StrMSlab,    Japanese,0},
  { "їеБЗё¶»Т",                                         StrMHydr,    Japanese,1},
  { "ҐШҐЖҐнё¶»Т",                                       StrMHet,     Japanese,2},
  { "µ±¤­",                                            StrMSpec,    Japanese,1},
  { "±Ж",                                              StrMShad,    Japanese,1},
  { "Ґ№ҐЖҐмҐЄ",                                         StrMStereo,  Japanese,5},
  { "ҐйҐЩҐл",                                          StrMLabel,   Japanese,0},
  { "ҐЄҐХ",                                          StrMPOff,    Japanese,5},
  { "БЄВт¤µ¤м¤ї¤в¤О¤тЙЅјЁ",                             StrMPIdent,  Japanese,5},
  { "µчОҐ¤тВ¬¤л",                                     StrMPDist,   Japanese,5},
  { "µчОҐ¤тЙЅјЁ",                                     StrMPMon,    Japanese,0},
  { "іСЕЩ¤тВ¬¤л",                                     StrMPAng,    Japanese,5},
  { "ЈІММіС¤т¤П¤«¤л",                                  StrMPTrsn,   Japanese,5},
  { "ҐйҐЩҐл¤тЙХ¤±¤л",                                  StrMPLabl,   Japanese,5}, 
  { "Гжїґ¤тАЯДк",                                     StrMPCent,   Japanese,5},
  { "єВЙё¤тЙЅјЁ",                                     StrMPCoord,  Japanese,6},
  { "·л№з¤т»ШДк",                                     StrMPBond,   Japanese,5},
  { "·л№з¤тІуЕѕ",                                     StrMRBond,   Japanese,0},
  { "К¬»Т¤тІуЕѕ",                                     StrMRMol,    Japanese,7},
  { "¤№¤Щ¤Ж¤тІуЕѕ",                                   StrMRAll,    Japanese,7},
  ...
  { "RasMolҐ№ҐЇҐкҐЧҐИ...",                           StrMSCR,     Japanese,8},  
  { "RasMol¤Л¤Д¤¤¤Ж...",                                StrMAbout,   Japanese,0},
  { "ҐЮҐЛҐеҐўҐл...",                                     StrMUserM,   Japanese,0},
  { "ёµ¤ЛМб¤№",                                         StrMUndo,    Japanese,0},
  { "Ґ«ҐГҐИ",                                           StrMCut,     Japanese,1},
  { "ҐіҐФЎј",                                           StrMCopy,    Japanese,1},
  { "ҐЪЎјҐ№ҐИ",                                         StrMPaste,   Japanese,0},
#ifdef APPLEMAC
  { "ѕГµо",                                             StrMClear,   Japanese,1},
#else
  { "єпЅь",                                             StrMDelete,  Japanese,0},
#endif
  { "¤№¤Щ¤Ж¤тБЄВт",                                       StrMSelAll,  Japanese,0},
  { "ҐХҐЎҐ¤Ґл",                                            StrMFile,    Japanese,0},
  { "КФЅё",                                            StrMEdit,    Japanese,0},
  { "ЙЅјЁКэЛЎ",                                         StrMDisplay, Japanese,0},
  { "ї§",                                         StrMColour,  Japanese,0},
  { "ҐЄҐЧҐ·ҐзҐу",                                         StrMOpt,     Japanese,0},
  { "АЯДк",                                        StrMSettings,Japanese,0},
  { "ІиБьЅРОП",                                          StrMExport,  Japanese,1},
#ifdef APPLEMAC
  { "Ґ¦Ґ¤ҐуҐЙҐ¦",                                          StrMWindow,  Japanese,0},
#endif
  { "ҐШҐлҐЧ",                                            StrMHelp,    Japanese,0},
#ifdef APPLEMAC
  { "ҐбҐ¤ҐуҐ¦Ґ¤ҐуҐЙҐ¦",                                     StrMMainWin,  Japanese,0},
  { "ҐіҐЮҐуҐЙҐйҐ¤Ґу",                                    StrMCmndLin,  Japanese,0},
#endif
#else
  { "і«¤Ї(&O) ...",                                       StrMOpen,    Japanese,0},
  { "ѕрКу(&I)",                                    StrMInfo,    Japanese,0},
  { "КД¤ё¤л(&C)",                                          StrMClose,   Japanese,0},
  { "°хєю(&P)",                                          StrMPrint,   Japanese,0},
  { "ҐЪЎјҐёАЯДк(&R)",                                    StrMPSetup,  Japanese,0},
  { "ЅЄО»(&E)",                                           StrMExit,    Japanese,0},
  { "ҐпҐ¤ҐдЎјҐХҐмЎјҐа(&W)",                                      StrMWirefr,  Japanese,0},
  { "јзєї(&M)",                                       StrMBackbn,  Japanese,0},
  { "Ґ№ҐЖҐЈҐГҐЇ(&B)",                                         StrMSticks,  Japanese,1},
  { "¶хґЦЅјЕ¶ҐвҐЗҐл(&S)",                                      StrMSpacefl, Japanese,0},
  { "ЛА¶М(&H)",                                  StrMBallStk, Japanese,0},
  { "ҐкҐЬҐу(&R)",                                        StrMRibbons, Japanese,0},
  { "Ґ№ҐИҐйҐуҐЙ(&T)",                                        StrMStrands, Japanese,3},
  { "Ґ«ЎјҐИҐҐЎјҐу(&C)",                                       StrMCartoon, Japanese,0},
  { "К¬»ТЙЅММ(&M)",                              StrMMolSurf, Japanese,0},
  { "Зт№х(&M)",                                     StrMMonochr, Japanese,0},
  { "&CPKЎКҐ«ҐйЎјЎЛ",                                            StrMCPK,     Japanese,0},
  { "·Б(&H)",                                        StrMShapely, Japanese,0},
  { "Ґ°ҐлЎјҐЧ(&G)",                                          StrMGroup,   Japanese,0},
  { "єї(&C)",                                          StrMChain,   Japanese,1},
  { "І№ЕЩ(&T)",                                    StrMTemp,    Japanese,0},
  { "№ЅВ¤(&S)",                                      StrMStruct,  Japanese,2},
  { "ҐжЎјҐ¶Ўј(&U)",                                           StrMUser,    Japanese,0},
  { "ҐвҐЗҐл(&D)",                                          StrMModel,   Japanese,2},
  { "ІДґ№№ЅВ¤(&A)",                                            StrMAlt,     Japanese,0},
  { "Ґ№ҐйҐЦҐвЎјҐЙ(&P)",                                      StrMSlab,    Japanese,0},
  { "їеБЗё¶»Т(&H)",                                      StrMHydr,    Japanese,1},
  { "ҐШҐЖҐнё¶»Т(&N)",                                   StrMHet,     Japanese,2},
  { "µ±¤­(&T)",                                       StrMSpec,    Japanese,1},
  { "±Ж(&D)",                                        StrMShad,    Japanese,1},
  { "Ґ№ҐЖҐмҐЄ(&S)",                                         StrMStereo,  Japanese,5},
  { "ҐйҐЩҐл(&L)",                                         StrMLabel,   Japanese,0},
  { "ҐЄҐХ(&O)",                                       StrMPOff,    Japanese,5},
  { "БЄВт¤µ¤м¤ї¤в¤О¤тЙЅјЁ(&I)",                                     StrMPIdent,  Japanese,5},
  { "µчОҐ¤тВ¬¤л(&D)",                                  StrMPDist,   Japanese,5},
  { "µчОҐ¤тЙЅјЁ(&S)",                                   StrMPMon,    Japanese,0},
  { "іСЕЩ¤тВ¬¤л(&A)",                                     StrMPAng,    Japanese,5},
  { "ЈІММіС¤т¤П¤«¤л(&T)",                                   StrMPTrsn,   Japanese,5},
  { "ҐйҐЩҐл¤тЙХ¤±¤л(&L)",                                     StrMPLabl,   Japanese,5}, 
  { "Гжїґ¤тАЯДк(&C)",                                    StrMPCent,   Japanese,5},
  { "єВЙё¤тЙЅјЁ(&X)",                                     StrMPCoord,  Japanese,6},
  { "·л№з¤т»ШДк(&B)",                                      StrMPBond,   Japanese,5},
  { "·л№з¤тІуЕѕ(&R)",                                    StrMRBond,   Japanese,0},
  { "К¬»Т¤тІуЕѕ(&M)",                                     StrMRMol,    Japanese,7},
  { "¤№¤Щ¤Ж¤тІуЕѕ(&H)",                                     StrMRAll,    Japanese,7},
  { "&BMP ...",                                        StrMBMP,     Japanese,0},  
  { "&GIF ...",                                        StrMGIF,     Japanese,0},  
  { "IRIS &RGB ...",                                   StrMIRGB,    Japanese,5},  
  ...
  { "RasMolҐ№ҐЇҐкҐЧҐИ(&C)...",                              StrMSCR,     Japanese,8},  
  { "RasMol¤Л¤Д¤¤¤Ж(&A)...",                                StrMAbout,   Japanese,0},
  { "ҐЮҐЛҐеҐўҐл(&M)...",                                 StrMUserM,   Japanese,0},
  { "ёµ¤ЛМб¤№(&Z)",                                           StrMUndo,    Japanese,0},
  { "Ґ«ҐГҐИ(&X)",                                            StrMCut,     Japanese,1},
  { "ҐіҐФЎј(&C)",                                           StrMCopy,    Japanese,1},
  { "ҐЪЎјҐ№ҐИ(&V)",                                          StrMPaste,   Japanese,0},
  { "єпЅь(&D)",                                         StrMDelete,  Japanese,0},
  { "¤№¤Щ¤Ж¤тБЄВт(&S)",                                     StrMSelAll,  Japanese,0},
  { "ҐХҐЎҐ¤Ґл(&F)",                                           StrMFile,    Japanese,0},
  { "КФЅё(&E)",                                           StrMEdit,    Japanese,0},
  { "ЙЅјЁКэЛЎ(&D)",                                        StrMDisplay, Japanese,0},
  { "ї§(&C)",                                        StrMColour,  Japanese,0},
  { "ҐЄҐЧҐ·ҐзҐу(&O)",                                        StrMOpt,     Japanese,0},
  { "АЯДк(&S)",                                       StrMSettings,    Japanese,0},
  { "ІиБьЅРОП(&X)",                                         StrMExport,  Japanese,1},
  { "ҐШҐлҐЧ(&H)",                                           StrMHelp,    Japanese,0},
#endif
  { "PDBҐХҐЎҐ¤ҐлМѕ:",                                  StrPrmtPDB,  Japanese,0},
  { "ІиБьҐХҐЎҐ¤ҐлМѕ:",                                StrPrmtImg,  Japanese,0},
  { "К¬»Т№ЅВ¤ҐХҐЎҐ¤ҐлМѕ:",                             StrPrmtMol,  Japanese,0},
  { "·Щ№р: ",                                           StrWarn,     Japanese,0},
  { "єї",                                              StrChain,    Japanese,0},
  { "ҐжЎјҐ¶ЎјЕРПї",                                        StrRegister, Japanese,0},
  { "ґуЙХ¤Л¤Д¤¤¤Ж",                                          StrDonate,   Japanese,0},
  { "µЇЖ°»ю¤Л¤і¤ОҐАҐ¤ҐўҐнҐ°¤тЙЅјЁ¤·¤К¤¤",              StrNoShow,   Japanese,0},
  { "GPL¤Л¤и¤лКЭѕЪМµ¤·¤ОҐЄЎјҐЧҐуҐЅЎјҐ№ЎЈґуЙХ¤т¤Єґк¤¤¤·¤Ю¤№ЎЈ", StrWarranty, Japanese,0}
